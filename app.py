...
#     # 2. 양계장 정보 가져오기 (보내주신 사진의 fms 스키마 반영)
#     # 모든 컬럼을 가져오도록 SELECT * 를 사용하거나 필요한 것만 적어주세요.
#     cursor.execute("SELECT chick_no, breeds, gender, hatchday, egg_weight, farm FROM fms.chick_info")
#     chicks = cursor.fetchall()
    
#     cursor.close()
#     conn.close()
    
#     # 3. index.html에 두 데이터 넘겨주기
#     return render_template('index.html', posts=posts, chicks=chicks)
